...
<!-- Авторизация через VK ID 
    ...
    Еще бы надо сделать:
    - При регистрации или авторизации делать проверку по email и если есть совпадение, то делать update учетной записи с добавлением VD ID и не регать нового пользователя
